...
abstract class CacheEloquentBaseRepository implements BaseRepository
{
    /**
     * @var Repository
     */
    ...
    {
        $this->cache = app(Illuminate\Cache\Repository::class);
        $this->cacheTime = config('cache.time', 10);
    }
    ...
    {
        return $this->cache
            ->tags([$this->entityName])
            ->remember('', $this->cacheTime, 
                function() use ($id) {
